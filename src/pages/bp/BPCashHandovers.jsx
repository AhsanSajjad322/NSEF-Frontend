...
const BPCashHandoversPage = () => {
  const [unprocessedTransactions, setUnprocessedTransactions] = useState([
    { id: 2, name: 'Sara Khan',class: "BESE-12A", amount: 10000, date: '2025-03-05', status: 'unprocessed' },
    { id: 4, name: 'Ayesha Siddiqui',class: "BESE-13A", amount: 5000, date: '2025-03-12', status: 'unprocessed' },
    { id: 7, name: 'Hamza Khan',class: "BESE-11A", amount: 12000, date: '2025-03-02', status: 'unprocessed' },
    { id: 9, name: 'Qasim Shah',class: "BESE-16A", amount: 9000, date: '2025-03-11', status: 'unprocessed' },
    { id: 11, name: 'Tahir Mehmood',class: "BEE-12A", amount: 6000, date: '2025-04-01', status: 'unprocessed' },
    { id: 13, name: 'Waqas Ali', class: "BESE-10A", amount: 11000, date: '2025-04-05', status: 'unprocessed' },
  ]);
  const [selectedTransactionIds, setSelectedTransactionIds] = useState(new Set());
  const [selectAll, setSelectAll] = useState(false);
  const [totalSelectedAmount, setTotalSelectedAmount] = useState(0);
  const [isHandoverModalOpen, setIsHandoverModalOpen] = useState(false);
  const [handoverRecipients] = useState(['NSFT 1', 'NSFT 2', 'NSFT 3']);
