...
const BPCashReceivalConfirmationPage = () => {
    // Sample data - replace with actual API calls
    const [transactionsToConfirm, setTransactionsToConfirm] = useState([
        { id: 101, crName: 'Ali Raza (CR)', amount: 7500, handoverDate: '2025-03-15', status: 'pending_bp_confirmation' },
        { id: 102, crName: 'Sana Khan (CR)', amount: 11000, handoverDate: '2025-03-16', status: 'pending_bp_confirmation' },
        { id: 103, crName: 'Usman Ghani (CR)', amount: 9000, handoverDate: '2025-03-17', status: 'pending_bp_confirmation' },
        { id: 104, crName: 'Zain Malik (CR)', amount: 6000, handoverDate: '2025-03-18', status: 'pending_bp_confirmation' },
        { id: 105, crName: 'Aisha Iqbal (CR)', amount: 12000, handoverDate: '2025-03-19', status: 'pending_bp_confirmation' },
        { id: 106, crName: 'Fahad Khan (CR)', amount: 8000, handoverDate: '2025-03-20', status: 'pending_bp_confirmation' },
        { id: 107, crName: 'Hira Butt (CR)', amount: 10500, handoverDate: '2025-03-21', status: 'pending_bp_confirmation' },
        { id: 108, crName: 'Kamran Ali (CR)', amount: 9500, handoverDate: '2025-03-22', status: 'pending_bp_confirmation' },
        { id: 109, crName: 'Sidra Khan (CR)', amount: 11500, handoverDate: '2025-03-23', status: 'pending_bp_confirmation' },
    ]);
        ...
        <div className="bg-background-DEFAULT min-h-screen">
            ...
            <div className="container mx-auto p-4">
                ...
                <div className="text-sm text-text-light mb-4">
                    BP / <span className="font-semibold text-text-DEFAULT">Cash Receival Confirmation</span>
                </div>
                            ...
                            <TableBody>
                                {currentTransactions.map((transaction) => (
                                    <TableRow key={transaction.id}>
                                        <TableCell>{transaction.crName}</TableCell>
                        ...
                        <div className="bg-white rounded-md shadow-lg w-full max-w-md">
                            ...
                            <div className="p-4 grid gap-4">
                                <div className="grid gap-2">
                                    <Label className="text-text-DEFAULT">CR Name:</Label>
...
export default BPCashReceivalConfirmationPage;